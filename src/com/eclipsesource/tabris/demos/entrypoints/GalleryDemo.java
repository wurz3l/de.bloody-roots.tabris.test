...
public class GalleryDemo implements IEntryPoint {
  ...
  public void createContent(Composite shell ) {
  ...
  private void createThumbnailsArea( Composite parentShell ) {
    thumbnailsArea = new Shell(parentShell.getShell(), SWT.NO_TRIM);
